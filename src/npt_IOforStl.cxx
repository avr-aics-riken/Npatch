...
// *********************************************************
//  関数名： GetNptNum_Binary
//  機能  ： STLの三角形の総数を取得（Nptの	Binaryコード）
//   in   ： InFile					（入力ファイル名、XXX.NPT）
//  out   ： 要素の総数
// *********************************************************
/**
